...
<h1><?php echo get_group_label($groups, $group_id) ?? '-' ?></h1>
<br>
    ...
    <tbody class="sortable">
        <?php foreach($users as $user): ?>
            <tr>
                ...
                <td><a href="<?php echo base_url("group/users/{$user->group_id}") ?>" class="text-inherit"><?php echo get_group_label($groups, $user->group_id) ?? '-' ?></a></td>
