<form method="post">
    <div class="form-group">
        ...
        <input type="text" class="form-control  <?php if (form_error('title')) echo 'is-invalid' ?>" name="title" id="title" autofocus value="<?php echo set_value('title', null) ?? $ticket->title ?? null ?>">
        <?php echo form_error('title') ?>
    </div>

    <div class="form-group">
        <label class="form-label" for="description">Description</label>
        <textarea class="ckeditor form-control  <?php if (form_error('description')) echo 'is-invalid' ?>" name="description" id="description" cols="30" rows="5"><?php echo set_value('description', null) ?? $ticket->description ?? null ?></textarea>
    ...
    <div class="form-group">
        ...
        <select class="selectize form-control  <?php if (form_error('project_id')) echo 'is-invalid' ?>" name="project_id" id="project_id">
    ...
    <?php else: ?>
        <div class="form-group">
            No projects set - <a href="<?php echo base_url('project/new') ?>">Manage projects</a>
        </div>
    <?php endif ?>
